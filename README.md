...
| `/dev/null`  | If you dont want to show the output you can send it to /dev/null, ` ls -l jfdkjfd 2>/dev/null` the error message will go to the null file which will descarded |
